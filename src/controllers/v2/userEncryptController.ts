...
import userEncryptServices from '../../services/v2/userEncryptServices'
import { IUserEncryotv2 } from '../../interfaces/UserEncrypt.interface'

export const getAllUsers = async (_req: Request, res: Response): Promise<IUserEncryotv2 | any> => {
  try {
...
export const getUsersAppX = async (_req: Request, res: Response): Promise<IUserEncryotv2 | any> => {
  try {
...
export const getUsersPCS = async (_req: Request, res: Response): Promise<IUserEncryotv2 | any> => {
  try {
...
export const updateUser = async (req: Request, res: Response): Promise<IUserEncryotv2 | any> => {
  try {
    const { id, pwd, aplicacion, appx, tipousuario, gestor, isEnable, Puestos } = req.body
    console.log(req.body)
    const user: IUserEncryotv2 = {
      Id: id,
      PwdEncryted: pwd,
...
export const insertUser = async (req: Request, res: Response): Promise<IUserEncryotv2 | any> => {
  try {
    const { usuario, pwd, gestor, aplicacion, appx, tipousuario, Puestos } = req.body
    const user: IUserEncryotv2 = {
      Usuario: usuario,
      PwdEncryted: pwd,
      Gestor: gestor,
...
export const decryptPass = async (req: Request, res: Response): Promise<IUserEncryotv2 | any> => {
  try {
    const { Id } = req.body
...
export const getTipoUsuario = async (_req: Request, res: Response): Promise<IUserEncryotv2 | any> => {
  try {
